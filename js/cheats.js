...
const CHEATS = [
  { id: 'peek', name: '透视之眼', icon: '👁️', cat: '手牌', type: 'toggle', desc: '看穿所有对手手牌与牌山' },
  { id: 'godHand', name: '神之一手', icon: '🎴', cat: '手牌', type: 'pattern', uses: 3, desc: '把手牌变成指定役满听牌' },
  { id: 'wish', name: '心想事成', icon: '🎯', cat: '手牌', type: 'tile', uses: 5, desc: '摸到任意想要的一张牌' },
  { id: 'clone', name: '无限复制', icon: '♾️', cat: '手牌', type: 'handtile', uses: 3, desc: '复制手里的一张牌（无视四张上限）' },
  { id: 'wishDora', name: '心想事成+', icon: '✨', cat: '手牌', type: 'toggle', desc: '下一次摸牌必是宝牌' },
  { id: 'tenhou', name: '开局天胡', icon: '☀️', cat: '胜负', type: 'instant', uses: 3, desc: '立刻天和，随机役满' },
  { id: 'instaWin', name: '一键胡牌', icon: '💥', cat: '胜负', type: 'pattern', uses: 5, desc: '立刻自摸指定的役满' },
  { id: 'money', name: '印钞机', icon: '💰', cat: '胜负', type: 'instant', uses: 5, desc: '自己 +10000 点' },
  { id: 'alwaysDealer', name: '永远连庄', icon: '♻️', cat: '胜负', type: 'toggle', desc: '每局强制自己做庄家' },
  { id: 'bomb', name: '炸牌', icon: '💣', cat: '破坏', type: 'opp', uses: 5, desc: '炸掉对手随机一张手牌' },
  { id: 'steal', name: '偷天换日', icon: '🕶️', cat: '破坏', type: 'opp', uses: 5, desc: '把对手一张牌偷到自己手里' },
  { id: 'doraHack', name: '篡改宝牌', icon: '🔥', cat: '破坏', type: 'tile', uses: 3, desc: '把宝牌指示牌改成指定牌' },
  { id: 'reshuffle', name: '掀桌重洗', icon: '🃏', cat: '破坏', type: 'instant', uses: 3, desc: '重新洗一遍整座牌山' },
  { id: 'mindRead', name: '读心术', icon: '🔮', cat: '操控', type: 'toggle', desc: '显示对手听什么牌与危险牌' },
  { id: 'hypnotize', name: '催眠大师', icon: '😴', cat: '操控', type: 'toggle', desc: 'AI 无法碰/吃/杠/和' },
  { id: 'puppet', name: '傀儡线', icon: '🪡', cat: '操控', type: 'opptile', uses: 3, desc: '指定对手打出某张牌（喂牌/放铳）' },
  { id: 'undo', name: '时光倒流', icon: '⏪', cat: '整活', type: 'instant', uses: 5, desc: '撤销上一步' },
];
